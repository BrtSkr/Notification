# Details
CSS is built with native nesting
...
Button next to notification: Can change both state to read: true and read:false (In real environment it would change state to read:true only)
